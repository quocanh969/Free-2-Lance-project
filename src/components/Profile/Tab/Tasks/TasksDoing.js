...
import { loadProcessingJobsForApplicant } from '../../../../actions/Job';
...
class TasksDoingComponent extends Component {
                            ...
                            <div className="row">
                                ...
                                <div className="col-10 text-left">
                                    ...
                                    <div className='mt-3'>
                                        ...
                                        <span className='btn mx-2 p-2 bg-danger text-white rounded'><i className="icon-line-awesome-warning" /> Báo cáo người thuê</span>
                                    </div>                                
                                </div>
                            </div>
                        </div>
    ...
    render() {
        let { totalProcessingTasks, currentProcessingPage } = this.props.ApplicantReducer;
