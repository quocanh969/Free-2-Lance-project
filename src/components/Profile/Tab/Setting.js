...
class SettingComponent extends Component {
  ...
  handleChangeCompanyInfoSubmit() {
    ...
    let numberOfEmployees = document.getElementById("number_of_employees")
      .value;
    ...
    if (updatePersonalStatus === 1) {
      ...
      return (
        <form
          onSubmit={(e) => {
            e.preventDefault();
            this.handleChangePersonalInfoSubmit();
          }}
        >
          {/* Thông tin nhân */}
          <div className="col-12">
                ...
                <div className="row">
                  <div className="col-auto">
                    ...
                    <input
                      ...
                      style={{ display: "none" }}
                      onChange={(e) => {
                        this.handleImageChange(e, "avt-img");
                      }}
                    />
                    <label
                      htmlFor="avt-img-input"
                      className="btn btn-primary py-1 w-100 text-center"
                    >
                          ...
                          <div className="account-type">
                            <div>
                              <label
                                ...
                                className={
                                  "ripple-effect-dark account-type-label " +
                                  (!user.isBusinessUser
                                    ? "account-type-check"
                                    : "")
                                }
          ...
          <div className="col-12">
            <div className="dashboard-box">
              ...
              <div className="headline">
                <h3>
                  <i className="icon-material-outline-face" /> Thông tin xác
                  thhực
                </h3>
              </div>
          ...
          <div className="col-12">
            <button
              ...
              type="submit"
            >
              Cập nhật thông tin cá nhân <i className="icon-feather-save" />
            </button>
          </div>
        </form>
      );
      ...
      if (updateCompanyStatus === 1) {
        ...
        return (
          <form
            onSubmit={(e) => {
              e.preventDefault();
              this.handleChangeCompanyInfoSubmit();
            }}
          >
            <div className="col-12">
              <div className="dashboard-box">
            ...
            <div className="col-xl-12">
              <button
                ...
                type="submit"
              >
                Cập nhật thông tin công ty <i className="icon-feather-save" />
              </button>
            </div>
          </form>
        );
      ...
      <div className="dashboard-content-inner">
        ...
        <div className="dashboard-headline d-flex justify-content-between">
          ...
          <div className="font-weight-bold">
            ...
            {user.account_status === 0 ? (
              <div>
                <h5 className="text-warning font-weight-bold mb-1">
                  <i className="icon-line-awesome-circle bg-warning rounded rounded-circle"></i>{" "}
                  Chưa kích hoạt
                </h5>
              ...
              <div>
                <h5 className="text-success font-weight-bold mb-1">
                  <i className="icon-line-awesome-circle bg-success rounded rounded-circle"></i>{" "}
                  Đã xác thực
                </h5>
              ...
              <div>
                <h5 className="text-danger font-weight-bold mb-1">
                  <i className="icon-line-awesome-circle bg-danger rounded rounded-circle"></i>{" "}
                  Bị cấm
                </h5>
        ...
        <div>
          ...
          <div id="company-info-flag" className="row">
            {user.isBusinessUser ? this.renderCompanyInfo() : ""}
          </div>
        </div>
        {/* Row / End */}
      </div>
...
const Setting = withRouter(
  connect(mapStateToProps, mapDispatchToProps)(SettingComponent)
);
