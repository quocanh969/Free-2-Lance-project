                ...
                <div className="single-page-header-inner">
                  <div className="left-side">
                    <div className="header-image freelancer-avatar">
                      <img src={UserAvatarBig02} alt="" />
                    </div>
                    <div className="header-details">
                      <h3>
                        {userDetail.personal
                          ? userDetail.personal.fullname
                          : ""}{" "}
                        <span>WWE Wrestler</span>
                      </h3>
                      <ul>
                        <li>
                        ...
                        <li>
                          <img className="flag" src={FlagDE} alt="" /> Germany
                        </li>
                        <li>
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-8 content-right-offset">
              ...
              <div className="boxed-list margin-bottom-60">
                <div className="boxed-list-headline">
                  <h3>
                    <i className="icon-material-outline-business" /> Employment
                    History
                  </h3>
                </div>
                <ul className="boxed-list-ul">
                  ...
                  <li>
                    <div className="boxed-list-item">
                      ...
                      <div className="item-content">
                        ...
                        <div className="item-description">
                          <p>
                            I designed and implemented 10+ custom web-based
                            CRMs, workflow systems, payment solutions and mobile
                            apps.
                          </p>
                        </div>
                      </div>
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="#" title="Behance" data-tippy-placement="top">
                          <i className="icon-brand-behance" />
                        </a>
                      </li>
                      <li>
                ...
                <form method="post" id="make-an-offer-form">
                  ...
                  <div className="uploadButton margin-top-25">
                    <input
                      ...
                      multiple
                    />
                    <label className="uploadButton-button" htmlFor="upload-cv">
                      Add Attachments
                    </label>
                    <span className="uploadButton-file-name">
                      Allowed file types: zip, pdf, png, jpg <br /> Max. files
